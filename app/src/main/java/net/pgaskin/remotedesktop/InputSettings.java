...
public final class InputSettings {
    ...
    private static final List<Tunable> TUNABLES = List.of(
            ...
            bool("hoverAssistEnabled", "Hover assist",
                    "Slow the pointer briefly when the remote cursor changes shape.",
                    c -> c.hoverAssistEnabled, (c, v) -> c.hoverAssistEnabled = v),
            ...
            bool("panMarginInsets", "Pan margin (display)",
                    "Additional panning space so the edges stay away from the rounded corners, camera cutout, and system bars.",
                    c -> c.panMarginInsets, (c, v) -> c.panMarginInsets = v),
            number("panMarginPx", "Pan margin (px)",
                    "Additional panning space to add to desktop edges, whether or not anything is over them.",
                    c -> c.panMarginPx, (c, v) -> c.panMarginPx = v),
