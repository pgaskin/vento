...
public final class InputSettings {
    ...
    private static final List<Tunable> TUNABLES = List.of(
            ...
            bool("panMarginEnabled", "Pan margin",
                    "Pan past the edges of the desktop, so the edges stay away from the rounded corners, camera cutout, and system bars.",
                    c -> c.panMarginEnabled, (c, v) -> c.panMarginEnabled = v),
